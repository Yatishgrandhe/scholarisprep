...
**Step 3:** Back-substitute: $y=16$.',
  ...
  updated_at = now()
WHERE id = 'e2c74873-a3e3-4518-892b-0f62a32ebbe0';
UPDATE public.questions SET
  question_text = 'Given $x+y=94$ and $2x-y=56$, what is $x$?',
  stimulus_text = 'At a fundraiser, 94 tickets were sold in two price tiers. VIP tickets cost twice as much as standard tickets, and revenue from 50 VIP and 44 standard tickets follows the system below.',
  options = '[{"id":"A","text":"$50$","is_correct":true,"explanation":"**Step 1:** Add equations: $3x=150$. **Step 2:** $x=50$."},{"id":"B","text":"$49$","is_correct":false,"explanation":"One less than the solution."},{"id":"C","text":"$44$","is_correct":false,"explanation":"That is $y$, not $x$."},{"id":"D","text":"$51$","is_correct":false,"explanation":"One more than the solution."}]'::jsonb,
  correct_answer = 'A',
  explanation = '**Step 1:** Add: $(x+y)+(2x-y)=94+56$ → $3x=150$.
**Step 2:** $x=50$.
**Step 3:** Back-substitute: $y=44$.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"model":"gemma-4-26b-a4b-it","original":true,"generator":"scholaris_ai_v1","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'e2d57c55-2d1d-4420-a239-3f88492f0d38';
UPDATE public.questions SET
  question_text = 'If $x^2 - 6x + 9 = 0$, what is the value of $x$?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"-3","is_correct":false,"explanation":"Choice A (-3…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"3","is_correct":true,"explanation":"Correct (B). Matches the worked solution above."},{"id":"C","text":"0","is_correct":false,"explanation":"Choice C (0…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"-9","is_correct":false,"explanation":"Choice D (-9…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'B',
  explanation = '**Step 1 — Understand the problem.** If $x^2 - 6x + 9 = 0$, what is the value of $x$?

**Step 2 — Solve.** The given equation is a perfect square trinomial. It can be factored as $(x-3)^2 = 0$. Taking the square root of both sides gives $x-3 = 0$. Adding 3 to both sides, we get $x = 3$.
...
- **D** (-9): Choice D (-9…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":744,"opensat_domain":"Advanced Math","opensat_raw_id":"b7539c69","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'e3098132-e652-4c49-aa0e-c7078946a7bc';
UPDATE public.questions SET
...
**Step 2:** At 95% confidence, true support likely falls in this range.',
  ...
  updated_at = now()
WHERE id = 'e310382b-0440-4e90-b3af-2a63e2ee5634';
UPDATE public.questions SET
  question_text = 'A circle has a radius of 6 units.  A chord of the circle is 8 units long.  What is the distance from the center of the circle to the chord?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"2","is_correct":true,"explanation":"Correct (A). Matches the worked solution above."},{"id":"B","text":"4","is_correct":false,"explanation":"Choice B (4…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"C","text":"$\\sqrt{28}$","is_correct":false,"explanation":"Choice C ($\\sqrt{28}$…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"$\\sqrt{52}$","is_correct":false,"explanation":"Choice D ($\\sqrt{52}$…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'A',
  explanation = '**Step 1 — Understand the problem.** A circle has a radius of 6 units.  A chord of the circle is 8 units long.  What is the distance from the center of the circle to the chord?

**Step 2 — Solve.** Draw a diagram of the circle, the chord, and the radius from the center of the circle to the midpoint of the chord.  This radius bisects the chord, creating two right triangles.  The hypotenuse of each triangle is a radius of the circle (6 units), and one leg of each triangle is half the chord (4 units).  We can use the Pythagorean Theorem to find the other leg (the distance from the center to the chord):  $6^2 = 4^2 + d^2$, where $d$ is the distance from the center of the circle to the chord.  Solving for $d$, we find $d = \sqrt{6^2 - 4^2} = \sqrt{20} = 2\sqrt{5}$.  Since the distance from the center to the chord is half of this distance, the distance from the center of the circle to the chord is $\sqrt{5}$ units.

**Step 3 — Select A.** 2

**Distractor analysis:**
- **B** (4): Choice B (4…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **C** ($\sqrt{28}$): Choice C ($\sqrt{28}$…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **D** ($\sqrt{52}$): Choice D ($\sqrt{52}$…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"CIR","domain_id":"geometry","opensat_index":619,"opensat_domain":"Geometry and Trigonometry","opensat_raw_id":"random_id_12","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
WHERE id = 'e316a77c-c034-4a9b-a1de-07ed77113c40';
UPDATE public.questions SET
  question_text = 'A linear function $f$ models temperature change. Given $f(3)=-1$ and $f(8)=19$, what is $f(-5)$?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"$-29$","is_correct":false,"explanation":"Adds slope once too many."},{"id":"B","text":"$4$","is_correct":false,"explanation":"That is the rate of change, not $f(-5$)."},{"id":"C","text":"$-36$","is_correct":false,"explanation":"Arithmetic error in point-slope form."},{"id":"D","text":"$-33$","is_correct":true,"explanation":"**Step 1:** Slope $m=4$. **Step 2:** $f(-5)=4(-5-3)+(-1)=-33$."}]'::jsonb,
  correct_answer = 'D',
  explanation = '**Step 1:** $m=\frac{19--1}{8-3}=4$.
**Step 2:** Point-slope: $f(-5)=4(-5-3)+(-1)$.
**Step 3:** $f(-5)=-33$.',
  difficulty = 'hard'::public.difficulty,
  ...
  updated_at = now()
WHERE id = 'e344a29f-15ae-4e20-98e9-141a8776255c';
UPDATE public.questions SET
...
**Step 2 — Solve.** Substituting \(\sqrt{3}\) for \(x\) into the function gives us \(f(\sqrt{3}) = \sqrt{(\sqrt{3})^2 + 1}\) which simplifies to \(f(\sqrt{3}) = \sqrt{3 + 1}\).  Therefore, \(f(\sqrt{3}) = \sqrt{4}\) = 2.
...
- **D** (4): Choice D (4…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":112,"opensat_domain":"Advanced Math","opensat_raw_id":"random_id_3","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
WHERE id = 'e34b6d88-3c1d-4db6-b0c3-f64c91824ce7';
UPDATE public.questions SET
  question_text = 'Given $x+y=108$ and $2x-y=63$, what is $x$?',
  stimulus_text = 'At a fundraiser, 108 tickets were sold in two price tiers. VIP tickets cost twice as much as standard tickets, and revenue from 57 VIP and 51 standard tickets follows the system below.',
  options = '[{"id":"A","text":"$57$","is_correct":true,"explanation":"**Step 1:** Add equations: $3x=171$. **Step 2:** $x=57$."},{"id":"B","text":"$56$","is_correct":false,"explanation":"One less than the solution."},{"id":"C","text":"$51$","is_correct":false,"explanation":"That is $y$, not $x$."},{"id":"D","text":"$58$","is_correct":false,"explanation":"One more than the solution."}]'::jsonb,
  correct_answer = 'A',
  explanation = '**Step 1:** Add: $(x+y)+(2x-y)=108+63$ → $3x=171$.
**Step 2:** $x=57$.
**Step 3:** Back-substitute: $y=51$.',
  ...
  updated_at = now()
WHERE id = 'e387ffc9-fa02-4c83-8274-2e58ee8c86fb';
...
**Step 2 — Solve.** The equation $\log_2 8 = x$ is equivalent to $2^x = 8$. Since $2^3 = 8$, the value of $x$ is 3.
...
- **D** (8): Choice D (8…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRM","domain_id":"advanced","opensat_index":935,"opensat_domain":"Advanced Math","opensat_raw_id":"random_id_a7","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'e3c25a3f-c5a1-46d4-80e1-e8a23af2eadc';
UPDATE public.questions SET
  question_text = 'The function *f* is defined by *f*(x) = 3x^2 + 5x - 2.  What is the value of *f*(2)?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"14","is_correct":false,"explanation":"Choice A (14…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"20","is_correct":false,"explanation":"Choice B (20…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"C","text":"28","is_correct":true,"explanation":"Correct (C). Matches the worked solution above."},{"id":"D","text":"36","is_correct":false,"explanation":"Choice D (36…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'C',
  explanation = '**Step 1 — Understand the problem.** The function *f* is defined by *f*(x) = 3x^2 + 5x - 2.  What is the value of *f*(2)?

**Step 2 — Solve.** To find *f*(2), we substitute 2 for *x* in the function: *f*(2) = 3(2)^2 + 5(2) - 2. Simplifying, we get *f*(2) = 3(4) + 10 - 2 = 12 + 10 - 2 = 28.
...
- **D** (36): Choice D (36…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":365,"opensat_domain":"Advanced Math","opensat_raw_id":"random_id_c6","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
WHERE id = 'e3eeb568-c888-41ab-984e-2ad3ce24e413';
UPDATE public.questions SET
  question_text = 'How many milliliters of substance A are in the mixture?',
  stimulus_text = 'A chemist mixes substances A and B in ratio $5:6$ to make 198 milliliters of solution.',
  options = '[{"id":"A","text":"$87$","is_correct":false,"explanation":"Underestimates A''s share."},{"id":"B","text":"$89$","is_correct":false,"explanation":"Close but ratio arithmetic is off."},{"id":"C","text":"$90$","is_correct":true,"explanation":"**Step 1:** A''s fraction $\\frac{5}{11}$. **Step 2:** $\\frac{5}{11}×198=90$."},{"id":"D","text":"$198$","is_correct":false,"explanation":"That is the total volume."}]'::jsonb,
  correct_answer = 'C',
  explanation = '**Step 1:** A''s share: $\frac{5}{11}$ of 198.
**Step 2:** $\frac{5}{11}×198=90$ mL.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"original":true,"generator":"scholaris_bulk_v1","explanation_v2":true,"math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'e4103cf5-e109-4743-bdf4-285f7415f4f5';
UPDATE public.questions SET
  question_text = 'How many milliliters of substance A are in the mixture?',
  stimulus_text = 'A chemist mixes substances A and B in ratio $3:6$ to make 78 milliliters of solution.',
  options = '[{"id":"A","text":"$23$","is_correct":false,"explanation":"Underestimates A''s share."},{"id":"B","text":"$25$","is_correct":false,"explanation":"Close but ratio arithmetic is off."},{"id":"C","text":"$26$","is_correct":true,"explanation":"**Step 1:** A''s fraction $\\frac{3}{9}$. **Step 2:** $\\frac{3}{9}×78=26$."},{"id":"D","text":"$78$","is_correct":false,"explanation":"That is the total volume."}]'::jsonb,
  correct_answer = 'C',
  explanation = '**Step 1:** A''s share: $\frac{3}{9}$ of 78.
**Step 2:** $\frac{3}{9}×78=26$ mL.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"original":true,"generator":"scholaris_bulk_v1","explanation_v2":true,"math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'e44e1145-f65f-4e19-ba86-8bf9182f86f5';
UPDATE public.questions SET
  question_text = 'The function *f* is defined by *f*(x) = *x*<sup>2</sup> + 3. What is the value of *f*(-2)?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"-1","is_correct":false,"explanation":"Choice A (-1…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"1","is_correct":false,"explanation":"Choice B (1…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"C","text":"7","is_correct":true,"explanation":"Correct (C). Matches the worked solution above."},{"id":"D","text":"13","is_correct":false,"explanation":"Choice D (13…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'C',
  explanation = '**Step 1 — Understand the problem.** The function *f* is defined by *f*(x) = *x*<sup>2</sup> + 3. What is the value of *f*(-2)?

**Step 2 — Solve.** To find *f*(-2), we substitute -2 for *x* in the equation *f*(x) = *x*<sup>2</sup> + 3: 
...
- **D** (13): Choice D (13…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRM","domain_id":"advanced","opensat_index":274,"opensat_domain":"Advanced Math","opensat_raw_id":"random_id_c5","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
WHERE id = 'e4bdc761-a806-42b9-a827-e5c673e081f0';
UPDATE public.questions SET
...
**Step 2 — Solve.** Substituting -2 for $x$ in the function, we get $f(-2) = 2(-2)^2 + 3(-2) - 1 = 8 - 6 - 1 = 1$. Therefore, the value of $f(-2)$ is -9.
...
- **D** (9): Choice D (9…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":591,"opensat_domain":"Advanced Math","opensat_raw_id":"random_id_c8","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'e4cc13e8-33c7-46b1-b4b1-16aa61b6065b';
UPDATE public.questions SET
  question_text = 'If $x + y = 5$ and $2x - y = 1$, what is the value of $x$?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"1","is_correct":false,"explanation":"Choice A (1…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"2","is_correct":true,"explanation":"Correct (B). Matches the worked solution above."},{"id":"C","text":"3","is_correct":false,"explanation":"Choice C (3…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"4","is_correct":false,"explanation":"Choice D (4…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'B',
  explanation = '**Step 1 — Understand the problem.** If $x + y = 5$ and $2x - y = 1$, what is the value of $x$?

**Step 2 — Solve.** To solve for *x*, we can add the two equations together.  This eliminates *y* and gives us $3x = 6$.  Dividing both sides by 3, we get $x = 2$.
...
- **D** (4): Choice D (4…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIF","domain_id":"algebra","opensat_index":752,"opensat_domain":"Algebra","opensat_raw_id":"82101135","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'e5279f40-947e-461c-99eb-b37bfb3cf87b';
UPDATE public.questions SET
  question_text = 'The equation $ax^2 + bx + c = 0$ has exactly one solution. What is the value of $b^2 - 4ac$?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"-1","is_correct":false,"explanation":"Choice A (-1…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"0","is_correct":true,"explanation":"Correct (B). Matches the worked solution above."},{"id":"C","text":"1","is_correct":false,"explanation":"Choice C (1…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"4","is_correct":false,"explanation":"Choice D (4…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'B',
  explanation = '**Step 1 — Understand the problem.** The equation $ax^2 + bx + c = 0$ has exactly one solution. What is the value of $b^2 - 4ac$?

**Step 2 — Solve.** A quadratic equation has exactly one solution when its discriminant is equal to zero. The discriminant of the quadratic equation $ax^2 + bx + c = 0$ is $b^2 - 4ac$. Therefore, the value of $b^2 - 4ac$ must be 0.
...
- **D** (4): Choice D (4…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIN","domain_id":"algebra","opensat_index":510,"opensat_domain":"Algebra","opensat_raw_id":"d68711e8","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.075Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
...
**Step 2 — Solve.** To solve for x, we can use the elimination method. Multiplying the second equation by 3, we get $3x - 3y = 3$. Adding this equation to the first equation, we get $5x = 15$. Dividing both sides by 5, we get $x = 3$.
...
- **D** (5): Choice D (5…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIF","domain_id":"algebra","opensat_index":901,"opensat_domain":"Algebra","opensat_raw_id":"random_id_c1","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.059Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = '1592559f-5410-4b03-ac82-438a8ccaa1b0';
UPDATE public.questions SET
  question_text = 'If $3x + 2y = 11$ and $x - y = 2$, what is the value of $x$?',
  stimulus_text = NULL,
  ...
  correct_answer = 'C',
  explanation = '**Step 1 — Understand the problem.** If $3x + 2y = 11$ and $x - y = 2$, what is the value of $x$?

**Step 2 — Solve.** To solve for $x$, we can use elimination.  Multiplying the second equation by 2, we get $2x - 2y = 4$. Adding this equation to the first equation, we get $5x = 15$. Dividing both sides by 5, we find $x = 3$.
...
- **D** (4): Choice D (4…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIF","domain_id":"algebra","opensat_index":772,"opensat_domain":"Algebra","opensat_raw_id":"random_id_11","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.059Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = '15ac1fc1-a2c2-4814-b7b2-8f6fbbc54f77';
UPDATE public.questions SET
  question_text = 'The equation $2x^2 + 5x - 3 = 0$ has two solutions. What is the sum of these two solutions?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"-\\frac{5}{2}","is_correct":true,"explanation":"Correct (A). Matches the worked solution above."},{"id":"B","text":"-\\frac{3}{2}","is_correct":false,"explanation":"Choice B (-\\frac{3}{2}…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"C","text":"\\frac{3}{2}","is_correct":false,"explanation":"Choice C (\\frac{3}{2}…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"\\frac{5}{2}","is_correct":false,"explanation":"Choice D (\\frac{5}{2}…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'A',
  explanation = '**Step 1 — Understand the problem.** The equation $2x^2 + 5x - 3 = 0$ has two solutions. What is the sum of these two solutions?

**Step 2 — Solve.** For a quadratic equation in the form $ax^2 + bx + c = 0$, the sum of the roots (solutions) is given by $-\frac{b}{a}$. In this case, a = 2 and b = 5.  Therefore, the sum of the roots is $-\frac{5}{2}$.

**Step 3 — Select A.** -\frac{5}{2}
...
- **D** (\frac{5}{2}): Choice D (\frac{5}{2}…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIN","domain_id":"algebra","opensat_index":478,"opensat_domain":"Algebra","opensat_raw_id":"a3d227c8","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.059Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
...
- **D** (5): Choice D (5…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"CIR","domain_id":"geometry","opensat_index":203,"opensat_domain":"Geometry and Trigonometry","opensat_raw_id":"random_id_c3","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.059Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
