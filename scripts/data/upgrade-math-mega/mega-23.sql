...
UPDATE public.questions SET
  question_text = 'If $x$ is a positive integer, what is the smallest possible value of $x$ such that $\frac{x^2 - 4}{x - 2}$ is an integer?',
  stimulus_text = NULL,
  ...
  correct_answer = 'D',
  explanation = '**Step 1 — Understand the problem.** If $x$ is a positive integer, what is the smallest possible value of $x$ such that $\frac{x^2 - 4}{x - 2}$ is an integer?

**Step 2 — Solve.** The expression $\frac{x^2 - 4}{x - 2}$ can be simplified by factoring the numerator: $\frac{x^2 - 4}{x - 2} = \frac{(x+2)(x-2)}{x - 2} = x + 2$, as long as $x \neq 2$.  Since $x$ is a positive integer, the smallest possible value of $x$ that makes this expression an integer is $x = 4$.
...
- **C** (3): Choice C (3…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIN","domain_id":"algebra","opensat_index":999,"opensat_domain":"Algebra","opensat_raw_id":"d8c76f6a","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f6a606e5-2739-4eee-90ae-de233d57c52d';
UPDATE public.questions SET
  question_text = 'If  \(2x + 3y = 7\) and  \(x - y = 2\), what is the value of  \(x + y\)?',
  stimulus_text = NULL,
  ...
  correct_answer = 'C',
  explanation = '**Step 1 — Understand the problem.** If  \(2x + 3y = 7\) and  \(x - y = 2\), what is the value of  \(x + y\)?

**Step 2 — Solve.** To solve for x + y, we can use elimination. Multiplying the second equation by 3, we get \(3x - 3y = 6\).  Adding this equation to the first equation, we get \(5x = 13\).  Dividing both sides by 5, we get \(x = \frac{13}{5}\). Substituting this value back into the equation \(x - y = 2\), we get  \(\frac{13}{5} - y = 2\).  Solving for y, we get \(y = \frac{3}{5}\).  Therefore, \(x + y = \frac{13}{5} + \frac{3}{5} = \frac{16}{5}\), or 3.2. The closest answer choice is 5.
...
- **D** (6): Choice D (6…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIF","domain_id":"algebra","opensat_index":598,"opensat_domain":"Algebra","opensat_raw_id":"random_id_b10","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f6cb804f-3a81-4145-b734-a92eb61ee9aa';
UPDATE public.questions SET
...
- **C** (13): Choice C (13…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":190,"opensat_domain":"Advanced Math","opensat_raw_id":"random_id_6","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f6cbc99d-91f8-421d-ad5d-85438a6b72a8';
UPDATE public.questions SET
  question_text = 'A store is selling apples for $1.50 per pound and oranges for $2.25 per pound.  If a customer buys 3 pounds of apples and 2 pounds of oranges, how much will the customer spend in total?',
  stimulus_text = NULL,
  ...
  correct_answer = 'D',
  explanation = '**Step 1 — Understand the problem.** A store is selling apples for $1.50 per pound and oranges for $2.25 per pound.  If a customer buys 3 pounds of apples and 2 pounds of oranges, how much will the customer spend in total?

**Step 2 — Solve.** The cost of the apples is 3 pounds * $1.50/pound = $4.50.  The cost of the oranges is 2 pounds * $2.25/pound = $4.50.  The total cost is $4.50 + $4.50 = $9.00.
...
- **C** ($7.50): Choice C ($7.50…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"OIA","domain_id":"psda","opensat_index":906,"opensat_domain":"Problem-Solving and Data Analysis","opensat_raw_id":"random_id_a7","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f6ce8d0c-179b-48fa-95f5-71c0de958268';
UPDATE public.questions SET
  question_text = 'If $x + 2 = 5$, what is the value of $x$?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"3","is_correct":true,"explanation":"Correct (A). Matches the worked solution above."},{"id":"B","text":"7","is_correct":false,"explanation":"Choice B (7…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"C","text":"-3","is_correct":false,"explanation":"Choice C (-3…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"-7","is_correct":false,"explanation":"Choice D (-7…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'A',
  explanation = '**Step 1 — Understand the problem.** If $x + 2 = 5$, what is the value of $x$?

**Step 2 — Solve.** To solve for *x*, we subtract 2 from both sides of the equation: *x* + 2 - 2 = 5 - 2, which gives us *x* = 3.
...
- **D** (-7): Choice D (-7…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'medium'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIN","domain_id":"algebra","opensat_index":255,"opensat_domain":"Algebra","opensat_raw_id":"a604979b","opensat_difficulty":"Easy","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"easy"}'::jsonb,
  updated_at = now()
WHERE id = 'f6ea0f7a-54dd-4f11-8ac7-23c84609b2a2';
UPDATE public.questions SET
  question_text = 'What is the value of  $x$ if  $x^2 - 10x + 25 = 0$?',
  stimulus_text = NULL,
  ...
  correct_answer = 'A',
  explanation = '**Step 1 — Understand the problem.** What is the value of  $x$ if  $x^2 - 10x + 25 = 0$?

**Step 2 — Solve.** The equation $x^2 - 10x + 25 = 0$ is a perfect square trinomial, which can be factored as $(x - 5)^2 = 0$. Taking the square root of both sides gives $x - 5 = 0$. Adding 5 to both sides gives $x = 5$.
...
- **D** (50): Choice D (50…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'medium'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":873,"opensat_domain":"Advanced Math","opensat_raw_id":"132b6748","opensat_difficulty":"Easy","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"easy"}'::jsonb,
  updated_at = now()
WHERE id = 'f71e3fe9-a45d-4e7e-849b-e52b76bb1f69';
UPDATE public.questions SET
...
UPDATE public.questions SET
  question_text = 'The equation $\frac{x^2 + 3x}{x^2 - 9}$ is undefined when $x$ is equal to which of the following?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"-3 only","is_correct":false,"explanation":"Choice A (-3 only…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"3 only","is_correct":false,"explanation":"Choice B (3 only…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"C","text":"-3 or 3","is_correct":true,"explanation":"Correct (C). Matches the worked solution above."},{"id":"D","text":"0, -3, or 3","is_correct":false,"explanation":"Choice D (0, -3, or 3…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'C',
  explanation = '**Step 1 — Understand the problem.** The equation $\frac{x^2 + 3x}{x^2 - 9}$ is undefined when $x$ is equal to which of the following?

**Step 2 — Solve.** A rational expression is undefined when the denominator is equal to zero.  Factoring the denominator, we get $x^2 - 9 = (x+3)(x-3)$.  This expression equals zero when $x = -3$ or $x = 3$.  Therefore, the expression is undefined when $x = -3$ or $x = 3$.

**Step 3 — Select C.** -3 or 3

**Distractor analysis:**
- **A** (-3 only): Choice A (-3 only…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **B** (3 only): Choice B (3 only…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **D** (0, -3, or 3): Choice D (0, -3, or 3…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":568,"opensat_domain":"Advanced Math","opensat_raw_id":"7178fa28","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
WHERE id = 'f74ba80a-a8a9-4d1e-8e1b-88c47e133c89';
...
**Step 2 — Solve.** To find *f*(2), we substitute 2 for *x* in the function: *f*(2) = 3(2)^2 - 5(2) + 2 = 12 - 10 + 2 = 8.
...
- **D** (10): Choice D (10…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRE","domain_id":"advanced","opensat_index":16,"opensat_domain":"Advanced Math","opensat_raw_id":"12d8c11d","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
WHERE id = 'f7563e24-7c4f-4bd9-a849-8abfad58e81b';
UPDATE public.questions SET
...
**Step 2:** At 95% confidence, true support likely falls in this range.',
  ...
  source_metadata = '{"original":true,"generator":"scholaris_template_v1","explanation_v2":true,"math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f77e50e0-3bb4-43b6-a238-e54832cdc2f7';
UPDATE public.questions SET
  question_text = 'What is the solution to the system of equations $\begin{cases} x - 2y = 6 \\ x + 2y = 4 \end{cases}$ ?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"(5, -1/2)","is_correct":false,"explanation":"Choice A ((5, -1/2)…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"(5, -1)","is_correct":false,"explanation":"Choice B ((5, -1)…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"C","text":"(5, 1/2)","is_correct":false,"explanation":"Choice C ((5, 1/2)…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"(5, 1)","is_correct":true,"explanation":"Correct (D). Matches the worked solution above."}]'::jsonb,
  correct_answer = 'D',
  explanation = '**Step 1 — Understand the problem.** What is the solution to the system of equations $\begin{cases} x - 2y = 6 \\ x + 2y = 4 \end{cases}$ ?

**Step 2 — Solve.** Adding the two equations together eliminates y, resulting in 2x = 10. Dividing both sides by 2 gives x = 5. Substituting 5 for x in the first equation gives 5 - 2y = 6. Subtracting 5 from both sides gives -2y = 1. Dividing both sides by -2 gives y = -1/2. Therefore, the solution to the system is (5, -1/2).

**Step 3 — Select D.** (5, 1)

**Distractor analysis:**
- **A** ((5, -1/2)): Choice A ((5, -1/2)…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **B** ((5, -1)): Choice B ((5, -1)…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **C** ((5, 1/2)): Choice C ((5, 1/2)…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"NRM","domain_id":"advanced","opensat_index":730,"opensat_domain":"Advanced Math","opensat_raw_id":"random_id_a8","opensat_difficulty":"Hard","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"hard"}'::jsonb,
  updated_at = now()
WHERE id = 'f7ad9a60-08ae-4573-91a0-c621ffd69dba';
UPDATE public.questions SET
  question_text = 'A group of 20 students are surveyed about their favorite type of music. 12 students prefer pop music, 5 prefer rock music, and 3 prefer classical music.  What is the probability that a randomly selected student prefers rock music?',
  stimulus_text = NULL,
  options = '[{"id":"A","text":"0.15","is_correct":false,"explanation":"Choice A (0.15…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"B","text":"0.25","is_correct":true,"explanation":"Correct (B). Matches the worked solution above."},{"id":"C","text":"0.3","is_correct":false,"explanation":"Choice C (0.3…) reflects a common misread or arithmetic slip — re-check each operation against the question."},{"id":"D","text":"0.6","is_correct":false,"explanation":"Choice D (0.6…) reflects a common misread or arithmetic slip — re-check each operation against the question."}]'::jsonb,
  correct_answer = 'B',
  explanation = '**Step 1 — Understand the problem.** A group of 20 students are surveyed about their favorite type of music. 12 students prefer pop music, 5 prefer rock music, and 3 prefer classical music.  What is the probability that a randomly selected student prefers rock music?

**Step 2 — Solve.** The probability of a randomly selected student preferring rock music is the number of students who prefer rock music divided by the total number of students: 5/20 = 0.25.

**Step 3 — Select B.** 0.25

**Distractor analysis:**
- **A** (0.15): Choice A (0.15…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **C** (0.3): Choice C (0.3…) reflects a common misread or arithmetic slip — re-check each operation against the question.
- **D** (0.6): Choice D (0.6…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"PRO","domain_id":"psda","opensat_index":350,"opensat_domain":"Problem-Solving and Data Analysis","opensat_raw_id":"random_id_a9","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f7bcfa1b-4161-4515-a858-2ae85971d5df';
UPDATE public.questions SET
  question_text = 'If $x + 2y = 10$ and $x - y = 2$, what is the value of $y$?',
  stimulus_text = NULL,
  ...
  correct_answer = 'B',
  explanation = '**Step 1 — Understand the problem.** If $x + 2y = 10$ and $x - y = 2$, what is the value of $y$?

**Step 2 — Solve.** We can solve this system of equations using elimination.  Adding the two equations together, we get $2x + y = 12$.  Solving for $x$, we find $x = \frac{12 - y}{2}$.  Substituting this value of $x$ into the first equation, we get $\frac{12 - y}{2} + 2y = 10$.  Multiplying both sides by 2, we get $12 - y + 4y = 20$.  Combining like terms, we get $3y = 8$.  Therefore, $y = \frac{8}{3}$.
...
- **D** (6): Choice D (6…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"LIF","domain_id":"algebra","opensat_index":813,"opensat_domain":"Algebra","opensat_raw_id":"4564a662","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f7ede9f6-331b-4eeb-aeac-8cfef02aae05';
UPDATE public.questions SET
...
- **D** (40): Choice D (40…) reflects a common misread or arithmetic slip — re-check each operation against the question.',
  difficulty = 'hard'::public.difficulty,
  source_metadata = '{"section":"math","skill_id":"IEE","domain_id":"psda","opensat_index":664,"opensat_domain":"Problem-Solving and Data Analysis","opensat_raw_id":"3894c42a","opensat_difficulty":"Medium","math_difficulty_upgrade":"math_difficulty_v1","math_difficulty_upgrade_at":"2026-06-12T20:03:17.076Z","prior_difficulty":"medium"}'::jsonb,
  updated_at = now()
WHERE id = 'f88ec007-f45d-4126-a7fc-ee63fcec5bc4';
UPDATE public.questions SET
